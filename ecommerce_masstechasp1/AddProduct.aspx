...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="width: 500px; border: 5px solid black; margin: 50px auto; border-radius: 1rem; background-color: rgba(255, 255, 255, 0.2);">
        <br />
        <h1 style="font-family: 'Arial', sans-serif; font-size: 36px; font-weight: bold; color: black; text-align: center;">Add Product</h1>
        <br />
